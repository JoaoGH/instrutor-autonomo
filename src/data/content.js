...
const TipoTestemunho = Object.freeze({
  HABILITADO: Object.freeze({
    value: 0,
    tagColor: 'bg-brand-100 text-brand-800',
    label: 'testimonials.licensed',
  }),
  APROVADO_DETRAN: Object.freeze({
    value: 1,
    tagColor: 'bg-amber-100 text-amber-800',
    label: 'testimonials.detranPassed',
  }),
  PRIMEIRA_HABILITACAO: Object.freeze({
    value: 2,
    tagColor: 'bg-blue-100 text-blue-800',
    label: 'testimonials.firstLicense',
  }),
});
